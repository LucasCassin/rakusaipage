...
export default function VideoAulasTaikoPage({ collections }) {
  // Configurações específicas para a página de Taiko
  const taikoPageConfig = {
    title: "Vídeoaulas Taiko",
    type: "taiko",
    defaultUrl: "videoaulas-taiko",
    requiredFeatures: [
      settings.videoAulas.FEATURE_TAIKO_INICIANTE,
      settings.videoAulas.FEATURE_TAIKO_INTERMEDIARIO,
      settings.videoAulas.FEATURE_TAIKO_AVANCADO,
  ...
  return (
    <VideoAulaCatalog collections={collections} pageConfig={taikoPageConfig} />
  );
}
