exports.up = async (pgm) => {
  await pgm.addColumns("pdv_sales", {
    notes: {
      ...
      notNull: false,
      comment:
        "Observação livre da venda (ex: nome/telefone para sorteio).",
    },
  });
  ...
  await pgm.addConstraint("pdv_settings", "pdv_settings_max_discount_percentage_chk", {
    check:
...
exports.down = async (pgm) => {
  await pgm.dropConstraint("pdv_settings", "pdv_settings_max_discount_percentage_chk");
